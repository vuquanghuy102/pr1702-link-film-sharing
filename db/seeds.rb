...
post = Post.create(
  ...
  time: "111",
  nation: "",
  link_trailer: "_EhiLLOhVis",
  user_id: "1")

PostCategory.create post_id: post.id, category_id: 4
PostCategory.create post_id: post.id, category_id: 9
PostCategory.create post_id: post.id, category_id: 13
...
post = Post.create(
  ...
  time: "104",
  nation: "",
  link_trailer: "52x5HJ9H8DM",
  user_id: "2")

PostCategory.create post_id: post.id, category_id: 6
PostCategory.create post_id: post.id, category_id: 5
PostCategory.create post_id: post.id, category_id: 9
...
post = Post.create(
  ...
  time: "124",
  nation: "",
  link_trailer: "xzyE4m1BDkI",
  user_id: "4")

PostCategory.create post_id: post.id, category_id: 4
PostCategory.create post_id: post.id, category_id: 6
PostCategory.create post_id: post.id, category_id: 2
PostCategory.create post_id: post.id, category_id: 14
...
post = Post.create(
  ...
  time: "129",
  nation: "",
  link_trailer: "Yba215606Mc",
  category_id: "6",
  user_id: "1")

PostCategory.create post_id: post.id, category_id: 1
PostCategory.create post_id: post.id, category_id: 6
PostCategory.create post_id: post.id, category_id: 11
